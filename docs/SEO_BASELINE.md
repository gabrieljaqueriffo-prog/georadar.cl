...
| `/herramientas/calculadora-viabilidad-gpr/` | Herramienta | Herramientas | `calculadora viabilidad GPR` | calculadora profundidad georradar, estimar profundidad GPR, viabilidad estudio GPR, herramienta GPR online | T | Ingenieros evaluando si su proyecto es viable para GPR antes de contactar | Resultado de viabilidad → WhatsApp | Mantener | ADR-006 ejecutado 2026-07-06: slug renombrado desde `/calculadora-profundidad/`. Redirect meta-refresh activo. Monitorear Search Console ~agosto 2026. |
...
| Revisar | 1 | `/herramientas/selector-antena/` |
| Mantener | 1 | `/herramientas/calculadora-viabilidad-gpr/` (ADR-006 ejecutado) |
...
3. **`/herramientas/calculadora-viabilidad-gpr/`** (monitorear): ADR-006 ejecutado. Redirect activo desde URL anterior. Verificar en Search Console ~agosto 2026 que la señal SEO se transfirió.
